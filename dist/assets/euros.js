...
;define("euros/routes/euros", ["exports", "ember-concurrency-ts", "euros/data/college", "euros/data/pintmen"], function (_exports, _emberConcurrencyTs, _college, _pintmen) {
  "use strict";
...
;
          if (!runningTests) {
            require("euros/app")["default"].create({"name":"euros","version":"0.0.0+7840aa05"});
          }
